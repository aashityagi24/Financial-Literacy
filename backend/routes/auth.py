...
async def google_login(request: Request):
    ...
    if "coinquest.co.in" in origin:
        ...
        callback_url = "https://money-garden-quest.preview.emergentagent.com/api/auth/google/callback"
        frontend_url = "https://money-garden-quest.preview.emergentagent.com"
    else:
