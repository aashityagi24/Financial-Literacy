...
async def get_job_guidebook(request: Request):
    ...
    if role == "child":
        return {
            ...
            "child_page_audios": guidebook.get("child_page_audios", [])
        }
    else:
        return {
            "child_guide": guidebook.get("child_guide", ""),
            ...
            "child_page_audios": guidebook.get("child_page_audios", []),
            "parent_page_audios": guidebook.get("parent_page_audios", [])
        }
...
async def update_job_guidebook(request: Request):
    ...
    await db.job_guidebook.update_one(
        ...
        {"$set": {
            ...
            "child_page_audios": body.get("child_page_audios", []),
            "parent_page_audios": body.get("parent_page_audios", []),
