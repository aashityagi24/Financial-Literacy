          ...
          {wallet?.accounts?.map((acc, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="capitalize text-sm opacity-90">{acc.account_type}</p>
                ...
                {info?.action && (
                  info.action.onClick === 'openGoal' ? (
                    <button 
                      onClick={() => setGoalOpen(true)}
                      className="mt-3 w-full py-2 bg-white/20 hover:bg-white/30 rounded-xl text-sm font-bold"
                    >
                      {info.action.label}
                    </button>
                  ) : (
                    <Link 
                      to={info.action.path}
                      className="mt-3 block w-full py-2 bg-white/20 hover:bg-white/30 rounded-xl text-sm font-bold text-center"
                    >
                      {info.action.label}
                    </Link>
                  )
